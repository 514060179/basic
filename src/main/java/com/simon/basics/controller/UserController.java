...
public class UserController {
    ...
    public ReturnParam sendCode(@RequestParam @Pattern(regexp = "^((1[3456789][0-9])|(14[57])|(17[0678])|(19[7]))\\d{8}$", message = "手机号码格式有误！") String phone) {
...
//        }
    ...
    public ReturnParam<User> add(User user, @Pattern(regexp = "^((1[3456789][0-9])|(14[57])|(17[0678])|(19[7]))\\d{8}$", message = "手机号码格式有误！")
